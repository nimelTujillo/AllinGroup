...
namespace WebOperaciones.BusWS {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="BusWS.IBuses")]
    public interface IBuses {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(WebOperaciones.BusWS.RepetidoException), Action="http://tempuri.org/IBuses/CrearMovilidadRepetidoExceptionFault", Name="RepetidoException", Namespace="http://schemas.datacontract.org/2004/07/WCFServices.Errores")]
        WebOperaciones.BusWS.Movilidad CrearMovilidad(WebOperaciones.BusWS.Movilidad movilidadACrear);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBuses/CrearMovilidad", ReplyAction="http://tempuri.org/IBuses/CrearMovilidadResponse")]
        System.Threading.Tasks.Task<WebOperaciones.BusWS.Movilidad> CrearMovilidadAsync(WebOperaciones.BusWS.Movilidad movilidadACrear);
        ...
        WebOperaciones.BusWS.Movilidad ObtenerMovilidad(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBuses/ObtenerMovilidad", ReplyAction="http://tempuri.org/IBuses/ObtenerMovilidadResponse")]
        System.Threading.Tasks.Task<WebOperaciones.BusWS.Movilidad> ObtenerMovilidadAsync(int id);
        ...
        WebOperaciones.BusWS.Movilidad ModificarMovilidad(WebOperaciones.BusWS.Movilidad movilidadAModificar);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBuses/ModificarMovilidad", ReplyAction="http://tempuri.org/IBuses/ModificarMovilidadResponse")]
        System.Threading.Tasks.Task<WebOperaciones.BusWS.Movilidad> ModificarMovilidadAsync(WebOperaciones.BusWS.Movilidad movilidadAModificar);
        ...
        WebOperaciones.BusWS.Movilidad[] ListarMovilidad();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBuses/ListarMovilidad", ReplyAction="http://tempuri.org/IBuses/ListarMovilidadResponse")]
        System.Threading.Tasks.Task<WebOperaciones.BusWS.Movilidad[]> ListarMovilidadAsync();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBuses/EnviarCorreo", ReplyAction="http://tempuri.org/IBuses/EnviarCorreoResponse")]
        void EnviarCorreo(string correo, string asunto, string mensaje, byte[] archivo, string nombreArchivo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBuses/EnviarCorreo", ReplyAction="http://tempuri.org/IBuses/EnviarCorreoResponse")]
        System.Threading.Tasks.Task EnviarCorreoAsync(string correo, string asunto, string mensaje, byte[] archivo, string nombreArchivo);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IBusesChannel : WebOperaciones.BusWS.IBuses, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class BusesClient : System.ServiceModel.ClientBase<WebOperaciones.BusWS.IBuses>, WebOperaciones.BusWS.IBuses {
        ...
        public WebOperaciones.BusWS.Movilidad CrearMovilidad(WebOperaciones.BusWS.Movilidad movilidadACrear) {
            return base.Channel.CrearMovilidad(movilidadACrear);
        }
        
        public System.Threading.Tasks.Task<WebOperaciones.BusWS.Movilidad> CrearMovilidadAsync(WebOperaciones.BusWS.Movilidad movilidadACrear) {
            return base.Channel.CrearMovilidadAsync(movilidadACrear);
        }
        
        public WebOperaciones.BusWS.Movilidad ObtenerMovilidad(int id) {
            return base.Channel.ObtenerMovilidad(id);
        }
        
        public System.Threading.Tasks.Task<WebOperaciones.BusWS.Movilidad> ObtenerMovilidadAsync(int id) {
            return base.Channel.ObtenerMovilidadAsync(id);
        }
        
        public WebOperaciones.BusWS.Movilidad ModificarMovilidad(WebOperaciones.BusWS.Movilidad movilidadAModificar) {
            return base.Channel.ModificarMovilidad(movilidadAModificar);
        }
        
        public System.Threading.Tasks.Task<WebOperaciones.BusWS.Movilidad> ModificarMovilidadAsync(WebOperaciones.BusWS.Movilidad movilidadAModificar) {
        ...
        public WebOperaciones.BusWS.Movilidad[] ListarMovilidad() {
            return base.Channel.ListarMovilidad();
        }
        
        public System.Threading.Tasks.Task<WebOperaciones.BusWS.Movilidad[]> ListarMovilidadAsync() {
            return base.Channel.ListarMovilidadAsync();
        }
        
        public void EnviarCorreo(string correo, string asunto, string mensaje, byte[] archivo, string nombreArchivo) {
            base.Channel.EnviarCorreo(correo, asunto, mensaje, archivo, nombreArchivo);
        }
        
        public System.Threading.Tasks.Task EnviarCorreoAsync(string correo, string asunto, string mensaje, byte[] archivo, string nombreArchivo) {
            return base.Channel.EnviarCorreoAsync(correo, asunto, mensaje, archivo, nombreArchivo);
        }
    }
}
